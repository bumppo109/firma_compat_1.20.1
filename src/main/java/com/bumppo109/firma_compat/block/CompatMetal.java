...
public enum CompatMetal implements RegistryMetal
{
    ...
    CompatMetal(int color, MapColor mapColor)
    {
        this.serializedName = name().toLowerCase(Locale.ROOT);
        this.color = color;
        this.mapColor = mapColor;
        this.sheet = FirmaCompatHelpers.modIdentifier("block/metal/full/" + serializedName);
    }
    ...
    {
        return ModBlocks.METALS.get(this).get(Metal.BlockType.BLOCK);
    }
    ...
    public enum ItemType
    {
        ...
        private final NonNullFunction<CompatMetal, Item> itemFactory;

        ItemType(NonNullFunction<CompatMetal, Item> itemFactory)
        {
            this.itemFactory = itemFactory;
        }

        public Item create(CompatMetal metal)
        {
